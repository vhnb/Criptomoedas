...
type DataProps = ReponseData | ErrorData
    ...
    return (
        <div className={styles.container}>
            ...
            <section className={styles.content}>
                <img className={styles.logo} src={`https://assets.coincap.io/assets/icons/${coin?.symbol.toLocaleLowerCase()}@2x.png`} alt='Logo Cripto Moeda' />
